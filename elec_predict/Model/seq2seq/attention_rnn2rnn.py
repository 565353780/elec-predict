...
from elec_predict.Model.Layer.inputs import Inputs
from elec_predict.Model.seq2seq.encoder import RNNEncoder
from elec_predict.Model.seq2seq.decoder import AttnRNNDecoder
