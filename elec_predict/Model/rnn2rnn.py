...
from elec_predict.Model.Layer.embeddings import Embeddings
from elec_predict.Model.Layer.concat import Concat
from elec_predict.Model.Layer.dense import Dense
from elec_predict.Model.Layer.attention import Attention
from elec_predict.Loss.rmse import RMSE
from elec_predict.Loss.rnn_stability import RNNStabilityLoss
from elec_predict.Loss.rnn_activation import RNNActivationLoss
from elec_predict.Method.init import init_rnn
...
class RNN2RNN(nn.Module):
    ...
    def batch_loss(self, x, y, w=None):
        ...
        if self.debug:
            print(f"yhat mean: {yhat.mean(): .2f}, target mean: {y.mean():.2f}")
