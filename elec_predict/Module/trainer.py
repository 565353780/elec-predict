...
class Trainer:
    ...
    def finish_info(self, message=None):
        if message is not None:
            print(message)
        print(f"training finished, best epoch {self.best_epoch}, best valid loss {self.best_loss:.4f}")
        ...
        for i in range(max_epochs):
            ...
            for j, (x, y) in enumerate(train_dl):
                ...
                if self.verbose > 0 and self.global_steps % self.verbose == 0:
                    print(f"epoch {self.epochs} / {max_epochs + start_epoch}, "
            ...
            print(f"epoch {self.epochs} / {max_epochs + start_epoch}, batch 100%, "
